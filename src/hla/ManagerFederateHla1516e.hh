...
#ifndef __MANAGER_FEDERATE_HLA1516E_HH_DEF__
#define __MANAGER_FEDERATE_HLA1516E_HH_DEF__
...
class ManagerFederateHla1516e : public rti1516e::NullFederateAmbassador 
{
	// Private  elements
	private:
	...
	public:
		...
		ManagerFederateHla1516e ( std::wstring FederationName
						  , std::wstring FederateName
					      , std::wstring FomFileName
					      );

		virtual ~ManagerFederateHla1516e();
		
		void create_curve_socket();
		void send_curve_data() ;
