...
int main(int argc, char *argv[])
{
	...
	std::string federateName   =  "f16_manager";
	std::string fomFile        =  "isae_prise_hla1516e.xml";
	
	std::wstring FederationName = ManagerFederateHla1516e::getWString(federationName.c_str());
	std::wstring FederateName = ManagerFederateHla1516e::getWString(federateName.c_str());
	std::wstring FomFile = ManagerFederateHla1516e::getWString(fomFile.c_str());
	...
	ManagerFederateHla1516e myFederate(FederationName, FederateName, FomFile);
