...
#ifndef __UNIT_CONVERSION_HH_DEF__
#define __UNIT_CONVERSION_HH_DEF__
...
// functions, and enumerated constants.    
//----------------------------------------------------------------------
class UnitConversion 
{
	...
	public:
		...
		// Finite precision comparison if the two values can be considered equal up to roundoff
		...
		// Locations Longitude, Latitude, Height
		enum {eLong=1,eLat,eH};
	...
	protected:
		...
		static const double FLtoft;
		static const double mintosec;
		static const double mpstoknots;
...
#endif // __UNIT_CONVERSION_HH_DEF__
